/// Full evaluation of all methods on RCV1-train (standalone vs DiMergeCo)
///
/// Usage: cargo run --release --example evaluate_rcv1_train_full
...
fn main() {
    ...
    // Load RCV1-train (full training set)
    ...
    println!("RCV1-train: {} x {} ({:.2} GB)", rows, cols, (rows * cols * 8) as f64 / 1e9);
