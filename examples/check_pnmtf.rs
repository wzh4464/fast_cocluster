//! PNMTF consistency check on Classic4 dataset.
//!
//! Runs Rust PNMTF on Classic4 with seeds 0-9, compares NMI/ARI against Python baselines.
//! Run: cargo run --release --example check_pnmtf
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("\nRunning PNMTF with {} seeds...", n_seeds);
    ...
    for seed in 0..n_seeds {
        ...
        let clusterer = PnmtfClusterer::with_config(config, 0.1, 0.1, 0.1);
    ...
    let baseline_path = "data/atom_baselines/pnmtf_classic4.json";
