//! ONM3F consistency check on Classic4 dataset.
//!
//! Runs Rust ONM3F on Classic4 with seeds 0-9, compares NMI/ARI against Python baselines.
//! Run: cargo run --release --example check_onm3f

use fast_cocluster::atom::onm3f::Onm3fClusterer;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("\nRunning ONM3F with {} seeds...", n_seeds);
    ...
    for seed in 0..n_seeds {
        ...
        let clusterer = Onm3fClusterer::with_config(config);
    ...
    let baseline_path = "data/atom_baselines/onm3f_classic4.json";
