//! FNMF consistency check on Classic4 dataset.
//!
//! Runs Rust FNMF on Classic4 with seeds 0-9, compares NMI/ARI against Python baselines.
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("\nRunning FNMF with {} seeds...", n_seeds);
    ...
    let baseline_path = "data/atom_baselines/fnmf_classic4.json";
