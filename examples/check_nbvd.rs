//! NBVD consistency check on Classic4 dataset.
//!
//! Runs Rust NBVD on Classic4 with seeds 0-9, compares NMI/ARI against Python baselines.
//! Run: cargo run --release --example check_nbvd
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("\nRunning NBVD with {} seeds...", n_seeds);
    ...
    let baseline_path = "data/atom_baselines/nbvd_classic4.json";
